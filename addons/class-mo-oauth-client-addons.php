...
<div class="outermost-div">
  <div class="row-view">
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/page-restriction.png", __FILE__)) ?>" width="40px" height="40px">
    ...
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/buddypress-logo.png", __FILE__)) ?>" width="40px" height="40px">
  ...
  <div class="row-view">
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/login-form.png", __FILE__)); ?>" width="40px" height="40px">
    ...
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/member-login.png", __FILE__)) ?>" width="40px" height="40px">
  ...
  <div class="row-view">
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/learndash-icon.png", __FILE__)) ?>" width="40px" height="40px">
    ...
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/report-icon.png", __FILE__)) ?>" width="40px" height="40px">
  ...
  <div class="row-view">
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/attribute-icon.png", __FILE__)) ?>" width="40px" height="40px">
    ...
    <div class="grid_view column_container">
      <div class="column_inner">
        <div class="row benefits-outer-block">
          <img src="<?php echo esc_url(plugins_url("images/scim-icon.png", __FILE__)) ?>" width="40px" height="40px">
