...
class Mo_OAuth_Client_Admin_Licensing {
    ...
    public static function show_licensing_page(){
        ...
        <form style="display:none;" id="loginform"
              ...
              <?php wp_nonce_field('mo_oauth_loginform','mo_oauth_loginform_field'); ?>
        ...
        <form style="display:none;" id="viewlicensekeys"
            <?php wp_nonce_field('mo_oauth_viewlicensekeys','mo_oauth_viewlicensekeys_field'); ?>
        ...
        <div class="mo-oauth-notice">
            <strong>Note:</strong> License is linked to the domain of the Wordpress instance, so if you have dev-staging-prod type of environment then you will require 3 licenses of the plugin (with discounts applicable on pre-production environments). To know more about different features, add-ons and all pricing plans you can visit our miniOrange OAuth SSO plugin's product page <a href="https://plugins.miniorange.com/wordpress-sso" target="_blank"><i>here</i></a>.
        </div>
                    ...
                    <div class="col-3 moct-align-center">
                                ...
                                <ul>
                                    ...
                                    <li>&#9989; <b>Add-Ons Support for below Add-Ons:</b></li>
                                        <ul style="list-style-position: inside";>
                                            <li type="square"; >BuddyPress Attribute Mapping,</li> <li type="square">Page Restriction,</li> <li type="square">Login Form Add-on,</li> <li type="square">Discord Role Mapping</li>
                                        </ul>
                                    <!-- </li> -->
                                </ul>
                            </div>
                        ...
                        <div class="moc-licensing-plan card-body">
                            ...
                            <div class="moc-licensing-plan-feature-list">
                                ...
                                <b>Please <a href="https://idp.miniorange.com/b2c-pricing" rel="noopener" target="_blank"><u>click here</u></a> to know more about our Identity Provider Services.
                                </b>
                            </div>
                        </div>
                    </div>
