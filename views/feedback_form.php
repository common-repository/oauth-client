...
function mo_oauth_client_display_feedback_form() {
	...
	$deactivate_reasons = array("Does not have the features I'm looking for", "Do not want to upgrade to Premium version", "Confusing Interface",
		"Bugs in the plugin", "Endpoints not available", "Other Reasons:");
...
?>
    ...
    <div id="oauth_client_feedback_modal" class="mo_modal">
        <div class="mo_modal-content">
            ...
            <?php wp_nonce_field('mo_oauth_client_feedback','mo_oauth_client_feedback_field'); ?>
            ...
            <?php wp_nonce_field('mo_oauth_client_skip_feedback','mo_oauth_client_skip_feedback_field'); ?>
    ...
    <script>
        jQuery('a[aria-label="Deactivate OAuth 2.0 client for SSO"]').click(function () {
