...
function mo_oauth_client_instructions($appname, $newdiv){
	...
	if($newdiv)
	 ...
	 <tr><td style="text-align:center;">miniOrange OAuth Server</td><td style="text-align:center;"><a target="_blank" href="https://plugins.miniorange.com/wordpress-oauth-server">Click Here</td></tr>
	 <tr><td style="text-align:center;">Custom OAuth Server</td><td style="text-align:center;"><a target="_blank" href="https://plugins.miniorange.com/wordpress-single-sign-on-sso-with-oauth-openid-connect">Click Here</td></tr>
	 </table> </ul>';
